...
namespace PhotoChemistry.Library
{
    public class WavelengthToRgbCalculator
    {
        const int
         LEN_MIN = 380,
         LEN_MAX = 780,
        ...
        public static byte[] Calc(double len)
        {
            ...
            double x = Interpolate(WavelengthToRgbCalculator.x, index, offset);
            double y = Interpolate(WavelengthToRgbCalculator.y, index, offset);
            double z = Interpolate(WavelengthToRgbCalculator.z, index, offset);

            double[] m = matrixSrgbD65;
        ...
        static double GammaCorrectSrgb(double c)
        {
            if (c <= 0.0031308)
                return 12.92 * c;
